...
class Deck extends Component {
    constructor(props) {
        ...
        this.state = {
            cards: [
                <Card picsum={`https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(72).webp`} context="Space" id="one" key="one" />,
                <Card picsum={`https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(73).webp`} context="Boat" id="two" key="two" />,
                <Card picsum={`https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(74).webp`} context="Wolf" id="three" key="three" />,
                <Card picsum={`https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(75).webp`} context="Artic" id="four" key="four" />
            ]
        }
    }
    ...
    componentDidMount() {
        ...
        let img_width_as_percentage = 70;
        ...
        window.addEventListener('resize', () => {
            img_width_as_percentage = 70;
            nav_buttons_placement_as_percentage = 90;
    ...
    render() {
        return (
            <>
            <div className="text-center bg-gray-50 text-gray-800 py-3 px-6">
    <h1 className="text-6xl font-bold mt-0 mb-5">Image Carousel</h1>
  </div>
...
<Fragment>
                ...
                <img onClick={this.handle_next} ref={ref_id => this.button_next = ref_id} src="./right-chevron.png" alt="next" id="next" style={styles.nav_button}/>
                </div>
